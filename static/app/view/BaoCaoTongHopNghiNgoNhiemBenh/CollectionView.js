define(function (require) {
    ...
    var template = require('text!app/view/BaoCaoTongHopNghiNgoNhiemBenh/tpl/collection.html'),
        ...
        tools : [
            {
                ...
                command: function() {
                    var self=this;
                    self.getApp().getRouter().navigate("baocaotonghopnghingonhiembenh/model");
                },
            },
        ],
        uiControl:{
            ...
            onRowClick: function (event) {
                if (event.rowId) {
                    var path =  'baocaotonghopnghingonhiembenh/model?id=' + event.rowId;
