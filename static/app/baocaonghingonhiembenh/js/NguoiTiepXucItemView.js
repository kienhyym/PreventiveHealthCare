define(function (require) {
	...
	var itemTemplate = require('text!tpl/BaoCaoNghiNgoNhiemBenh/nguoitiepxucitem.html'),
		itemSchema = require('json!app/view/BaoCaoNghiNgoNhiemBenh/NguoiTiepXucSchema.json');
