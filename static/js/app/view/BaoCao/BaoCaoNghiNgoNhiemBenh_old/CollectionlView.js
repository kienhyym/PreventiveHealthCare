...
//     var template = require('text!tpl/BaoCao/nghingonguoibenhcollection.html'),
...
//                 { field: "donvi", label: "Tên đơn vị", width: 250 },
...
//                 if (event.rowId) {
//                     var path = "baocao/" + this.collectionName + '/model?id=' + event.rowId;
//                     console.log(path);
