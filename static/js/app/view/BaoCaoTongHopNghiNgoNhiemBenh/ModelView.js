define(function (require) {
	...
	return Gonrin.ModelView.extend({
		...
		render: function () {
			...
			self.$el.find(".hide_selectdonvi").hide();
				...
				$.ajax({
					...
					success: function (data) {
						...
						if(data !==null  && data.ten !==undefined){
							...
							tr_third.append('<td rowspan="'+(number_row+1)+'">Số hành khách nghi ngờ nhiễm bệnh</td>');

							var tr_tong_hanhkhach = $('<tr style="font-style: bold" id="tong_hanhkhach">');
							var tr_tong_chuyenbay = $('<tr style="font-style: bold" id="tong_hanhkhach">');
							var tr_tong_nguoinghingo = $('<tr style="font-style: bold" id="tong_hanhkhach">')

							tr_tong_hanhkhach.append('<td colspan="2" class="text-center">Cộng dồn</td>');
							tr_tong_chuyenbay.append('<td colspan="2" class="text-center">Cộng dồn</td>');
							tr_tong_nguoinghingo.append('<td colspan="2" class="text-center">Cộng dồn</td>');
							...
							for (var i = 0; i < data.data[0].data_khaibao.length; i++) {
								...
								for(var j=0; j<data.data.length; j++) {
									...
									if(i==0) {
										...
										tr_third.append('<td  class="text-center">' + self.validate_null(value_nghingo) + '</td>');
										tr_tong_hanhkhach.append('<td  class="text-center" id="td_tong_'+j+'">' + item_data_col[i].value_hanhkhach + '</td>');
										tr_tong_chuyenbay.append('<td  class="text-center" id="td_tong_chuyenbay_'+j+'">' + item_data_col[i].value_chuyenbay + '</td>');
										tr_tong_nguoinghingo.append('<td  class="text-center" id="td_tong_nguoinghingo_'+j+'">' + item_data_col[i].value_nguoinghingo + '</td>')
							...
							for (var i = 0;i < data.data.length;i++) {
								...
								self.$el.find("#body-data td#td_tong_"+i).text(hanhkhach_cuakhau);
