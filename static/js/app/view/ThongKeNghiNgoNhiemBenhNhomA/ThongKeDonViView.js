define(function (require) {
	...
	var template = require('text!tpl/ThongKeNghiNgoNhiemBenhNhomA/donvi.html'),
	...
	return Gonrin.View.extend({
		...
		registerEvent: function(){
			...
			self.$el.find("#btn-export-report").unbind("click").bind('click',function(){
				...
				var url = self.getApp().serviceURL + '/api/v1/thongketonghopnghingonhiembenhnhoma/donvi';
			...
			self.$el.find("#btn-view-report").unbind("click").bind('click',function(){
				...
				$.ajax({
					url: self.getApp().serviceURL + '/api/v1/thongketonghopnghingonhiembenhnhoma/donvi',
					dataType: "json",
					type: "GET",
					data: params,
